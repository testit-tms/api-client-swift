...
public struct CustomAttributePutModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID, options: [CustomAttributeOptionModel]? = nil, type: CustomAttributeTypesEnum, isDeleted: Bool, name: String, isEnabled: Bool, isRequired: Bool, isGlobal: Bool) {
        self.id = id
