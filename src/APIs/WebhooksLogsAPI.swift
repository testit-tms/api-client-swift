...
internal class WebhooksLogsAPI {
     ...
     */
    @discardableResult
    internal class func apiV2WebhooksLogsGet(projectId: UUID? = nil, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [WebHookLogModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2WebhooksLogsGetWithRequestBuilder(projectId: UUID? = nil, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil) -> RequestBuilder<[WebHookLogModel]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[WebHookLogModel]>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    internal class func apiV2WebhooksLogsIdDelete(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2WebhooksLogsIdDeleteWithRequestBuilder(id: UUID) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2WebhooksLogsIdGet(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: WebHookLogModel?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<WebHookLogModel> 
     */
    internal class func apiV2WebhooksLogsIdGetWithRequestBuilder(id: UUID) -> RequestBuilder<WebHookLogModel> {
        var localVariablePath = "/api/v2/webhooks/logs/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
