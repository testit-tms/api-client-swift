...
internal class BackgroundJobsAPI {
     ...
     */
    @discardableResult
    internal class func apiV2BackgroundJobsCompletedDelete(apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2BackgroundJobsCompletedDeleteWithRequestBuilder() -> RequestBuilder<Void> {
    ...
    @discardableResult
    internal class func apiV2BackgroundJobsGet(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [BackgroundJobGetModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    internal class func apiV2BackgroundJobsGetWithRequestBuilder(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil) -> RequestBuilder<[BackgroundJobGetModel]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[BackgroundJobGetModel]>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    internal class func apiV2BackgroundJobsIdCancelPost(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func apiV2BackgroundJobsIdCancelPostWithRequestBuilder(id: UUID) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2BackgroundJobsIdGet(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: BackgroundJobGetModel?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<BackgroundJobGetModel> 
     */
    internal class func apiV2BackgroundJobsIdGetWithRequestBuilder(id: UUID) -> RequestBuilder<BackgroundJobGetModel> {
     ...
     */
    @discardableResult
    internal class func apiV2BackgroundJobsIdStatusGet(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: BackgroundJobState?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2BackgroundJobsIdStatusGetWithRequestBuilder(id: UUID) -> RequestBuilder<BackgroundJobState> {
        ...
        let localVariableRequestBuilder: RequestBuilder<BackgroundJobState>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    internal class func apiV2BackgroundJobsSearchPost(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, backgroundJobFilterModel: BackgroundJobFilterModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [BackgroundJobGetModel]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<[BackgroundJobGetModel]> 
     */
    internal class func apiV2BackgroundJobsSearchPostWithRequestBuilder(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, backgroundJobFilterModel: BackgroundJobFilterModel? = nil) -> RequestBuilder<[BackgroundJobGetModel]> {
