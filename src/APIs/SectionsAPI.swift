...
internal class SectionsAPI {
     ...
     */
    @discardableResult
    internal class func apiV2SectionsIdPatch(id: UUID, operation: [Operation]? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2SectionsIdPatchWithRequestBuilder(id: UUID, operation: [Operation]? = nil) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func createSection(sectionPostModel: SectionPostModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: SectionWithStepsModel?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func createSectionWithRequestBuilder(sectionPostModel: SectionPostModel? = nil) -> RequestBuilder<SectionWithStepsModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<SectionWithStepsModel>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    internal class func deleteSection(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func deleteSectionWithRequestBuilder(id: UUID) -> RequestBuilder<Void> {
        var localVariablePath = "/api/v2/sections/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
     ...
     */
    @discardableResult
    internal class func getSectionById(id: UUID, isDeleted: DeletionState? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: SectionWithStepsModel?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<SectionWithStepsModel> 
     */
    internal class func getSectionByIdWithRequestBuilder(id: UUID, isDeleted: DeletionState? = nil) -> RequestBuilder<SectionWithStepsModel> {
        var localVariablePath = "/api/v2/sections/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    internal class func getWorkItemsBySectionIdWithRequestBuilder(id: UUID, isDeleted: Bool? = nil, tagNames: [String]? = nil, includeIterations: Bool? = nil, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil) -> RequestBuilder<[WorkItemShortModel]> {
     ...
     */
    @discardableResult
    internal class func move(sectionMoveModel: SectionMoveModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func moveWithRequestBuilder(sectionMoveModel: SectionMoveModel? = nil) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func rename(sectionRenameModel: SectionRenameModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func renameWithRequestBuilder(sectionRenameModel: SectionRenameModel? = nil) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func updateSection(sectionPutModel: SectionPutModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func updateSectionWithRequestBuilder(sectionPutModel: SectionPutModel? = nil) -> RequestBuilder<Void> {
        let localVariablePath = "/api/v2/sections"
        let localVariableURLString = ruTestitApiClientAPI.basePath + localVariablePath
