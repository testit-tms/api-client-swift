...
```swift
    internal class func addTestPointsToTestSuite(id: UUID, workItemSelectModel: WorkItemSelectModel? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2TestSuitesIdPatch(id: UUID, operation: [Operation]? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2TestSuitesIdRefreshPost(id: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2TestSuitesIdWorkItemsPost(id: UUID, requestBody: Set<UUID>? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **apiV2TestSuitesPost**
```swift
    internal class func apiV2TestSuitesPost(testSuiteV2PostModel: TestSuiteV2PostModel? = nil, completion: @escaping (_ data: TestSuiteV2GetModel?, _ error: Error?) -> Void)
```
...
# **apiV2TestSuitesPut**
```swift
    internal class func apiV2TestSuitesPut(testSuiteV2PutModel: TestSuiteV2PutModel? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **deleteTestSuite**
```swift
    internal class func deleteTestSuite(id: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func getConfigurationsByTestSuiteId(id: UUID, completion: @escaping (_ data: [ConfigurationModel]?, _ error: Error?) -> Void)
```
...
# **getTestPointsById**
```swift
    internal class func getTestPointsById(id: UUID, completion: @escaping (_ data: [TestPointByTestSuiteModel]?, _ error: Error?) -> Void)
```
...
# **getTestResultsById**
```swift
    internal class func getTestResultsById(id: UUID, completion: @escaping (_ data: [TestResultV2ShortModel]?, _ error: Error?) -> Void)
```
...
# **getTestSuiteById**
```swift
    internal class func getTestSuiteById(id: UUID, completion: @escaping (_ data: TestSuiteV2GetModel?, _ error: Error?) -> Void)
```
...
# **searchWorkItems**
```swift
    internal class func searchWorkItems(id: UUID, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, testSuiteWorkItemsSearchModel: TestSuiteWorkItemsSearchModel? = nil, completion: @escaping (_ data: [WorkItemShortModel]?, _ error: Error?) -> Void)
```
...
```swift
    internal class func setConfigurationsByTestSuiteId(id: UUID, requestBody: Set<UUID>? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
