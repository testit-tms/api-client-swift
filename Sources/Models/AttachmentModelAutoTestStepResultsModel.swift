...
public struct AttachmentModelAutoTestStepResultsModel: Codable, JSONEncodable, Hashable {
    ...
    public var stepResults: [AttachmentModelAutoTestStepResultsModel]?
    ...
    public init(title: String? = nil, description: String? = nil, info: String? = nil, startedOn: Date? = nil, completedOn: Date? = nil, duration: Int64? = nil, outcome: AvailableTestResultOutcome? = nil, stepResults: [AttachmentModelAutoTestStepResultsModel]? = nil, attachments: [AttachmentModel]? = nil, parameters: [String: String]? = nil) {
        self.title = title
