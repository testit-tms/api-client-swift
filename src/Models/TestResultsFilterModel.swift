...
internal struct TestResultsFilterModel: Codable, JSONEncodable, Hashable {
    ...
    internal var testRunIds: [UUID]?
    /** Specifies an autotest global IDs to search results for */
    internal var autoTestGlobalIds: [Int64]?
    ...
    internal var startedOn: DateTimeRangeSelectorModel?
    /** Specifies a test result completed on date and time range to search for */
    internal var completedOn: DateTimeRangeSelectorModel?
    ...
    internal var resultReasons: [String]?
    ...
    internal init(testRunIds: [UUID]? = nil, autoTestGlobalIds: [Int64]? = nil, name: String? = nil, createdDate: DateTimeRangeSelectorModel? = nil, modifiedDate: DateTimeRangeSelectorModel? = nil, startedOn: DateTimeRangeSelectorModel? = nil, completedOn: DateTimeRangeSelectorModel? = nil, duration: Int64RangeSelectorModel? = nil, resultReasons: [String]? = nil, configurationIds: [UUID]? = nil, outcomes: [TestResultOutcome]? = nil, failureCategories: [FailureCategoryModel]? = nil, namespace: String? = nil, className: String? = nil) {
