...
internal struct WorkItemShortModel: Codable, JSONEncodable, Hashable {
    ...
    internal var links: [LinkShortModel]

    internal init(id: UUID, versionId: UUID, versionNumber: Int, name: String, entityTypeName: String, projectId: UUID, sectionId: UUID, sectionName: String, isAutomated: Bool, globalId: Int64, duration: Int, medianDuration: Int64? = nil, attributes: [String: AnyCodable]? = nil, createdById: UUID, modifiedById: UUID? = nil, createdDate: Date? = nil, modifiedDate: Date? = nil, state: WorkItemStates, priority: WorkItemPriorityModel, isDeleted: Bool, tagNames: [String]? = nil, iterations: [IterationModel], links: [LinkShortModel]) {
        self.id = id
