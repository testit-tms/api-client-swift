...
internal class AttachmentsAPI {
     ...
     */
    @discardableResult
    internal class func apiV2AttachmentsIdDelete(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2AttachmentsIdDeleteWithRequestBuilder(id: UUID) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2AttachmentsIdGet(id: UUID, width: Int? = nil, height: Int? = nil, resizeType: ImageResizeType? = nil, backgroundColor: String? = nil, preview: Bool? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func apiV2AttachmentsIdGetWithRequestBuilder(id: UUID, width: Int? = nil, height: Int? = nil, resizeType: ImageResizeType? = nil, backgroundColor: String? = nil, preview: Bool? = nil) -> RequestBuilder<Void> {
        var localVariablePath = "/api/v2/attachments/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
     ...
     */
    @discardableResult
    internal class func apiV2AttachmentsOccupiedFileStorageSizeGet(apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Int64?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2AttachmentsOccupiedFileStorageSizeGetWithRequestBuilder() -> RequestBuilder<Int64> {
     ...
     */
    @discardableResult
    internal class func apiV2AttachmentsPost(file: URL? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: AttachmentModel?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2AttachmentsPostWithRequestBuilder(file: URL? = nil) -> RequestBuilder<AttachmentModel> {
