//
// ConfigurationParameterApiResult.swift
//
...
public struct ConfigurationParameterApiResult: Codable, JSONEncodable, Hashable {
    ...
    public var values: [ConfigurationParameterValueApiResult]
    /** List of assigned projects */
    public var projects: [ProjectNameApiResult]

    public init(id: UUID, name: String, isDeleted: Bool, createdDate: Date, createdById: UUID, modifiedDate: Date, modifiedById: UUID, values: [ConfigurationParameterValueApiResult], projects: [ProjectNameApiResult]) {
        self.id = id
        self.name = name
