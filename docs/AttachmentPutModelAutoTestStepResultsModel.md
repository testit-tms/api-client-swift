...
**stepResults** | [AttachmentPutModelAutoTestStepResultsModel] | Nested step results. The maximum nesting level is 15. | [optional] 
**attachments** | [AttachmentPutModel] | /// &lt;summary&gt;  Specifies an attachment GUID. Multiple values can be sent.  &lt;/summary&gt; | [optional] 
