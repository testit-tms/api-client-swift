...
```swift
    internal class func addGlobaAttributesToProject(id: String, requestBody: Set<UUID>? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsDemoPost(projectPostModel: ProjectPostModel? = nil, completion: @escaping (_ data: ProjectModel?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsIdDelete(id: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsIdFailureClassesGet(id: String, isDeleted: Bool? = nil, completion: @escaping (_ data: [FailureClassModel]?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsIdFavoritePut(id: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsIdFiltersGet(id: String, completion: @escaping (_ data: [FilterModel]?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsIdPatch(id: UUID, operation: [Operation]? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsIdPurgePost(id: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsIdRestorePost(id: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsIdTestPlansAttributeAttributeIdDelete(id: String, attributeId: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsIdTestPlansAttributePut(id: String, customAttributeTestPlanProjectRelationPutModel: CustomAttributeTestPlanProjectRelationPutModel? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsIdTestRunsActiveGet(id: String, completion: @escaping (_ data: [PublicTestRunModel]?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsNameNameExistsGet(name: String, completion: @escaping (_ data: Bool?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsPurgeBulkPost(projectSelectModel: ProjectSelectModel? = nil, completion: @escaping (_ data: Int64?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsRestoreBulkPost(projectSelectModel: ProjectSelectModel? = nil, completion: @escaping (_ data: Int64?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2ProjectsSearchPost(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, projectsFilterModel: ProjectsFilterModel? = nil, completion: @escaping (_ data: [ProjectModel]?, _ error: Error?) -> Void)
```
...
```swift
    internal class func backgroundImportProject(file: URL? = nil, completion: @escaping (_ data: UUID?, _ error: Error?) -> Void)
```
...
```swift
    internal class func backgroundImportZipProject(file: URL? = nil, completion: @escaping (_ data: UUID?, _ error: Error?) -> Void)
```
...
# **callImport**
```swift
    internal class func callImport(includeAttachments: Bool? = nil, file: URL? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **createProject**
```swift
    internal class func createProject(projectPostModel: ProjectPostModel? = nil, completion: @escaping (_ data: ProjectModel?, _ error: Error?) -> Void)
```
...
```swift
    internal class func deleteProjectAutoTests(id: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **getAllProjects**
```swift
    internal class func getAllProjects(isDeleted: Bool? = nil, projectName: String? = nil, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, completion: @escaping (_ data: [ProjectModel]?, _ error: Error?) -> Void)
```
...
```swift
    internal class func getAutoTestsNamespaces(id: String, completion: @escaping (_ data: [AutoTestNamespaceModel]?, _ error: Error?) -> Void)
```
...
# **getProjectById**
```swift
    internal class func getProjectById(id: String, completion: @escaping (_ data: ProjectModel?, _ error: Error?) -> Void)
```
...
```swift
    internal class func getTestPlansByProjectId(id: String, isDeleted: Bool? = nil, completion: @escaping (_ data: [TestPlanModel]?, _ error: Error?) -> Void)
```
...
# **updateProject**
```swift
    internal class func updateProject(projectPutModel: ProjectPutModel? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
