...
internal class ProjectConfigurationsAPI {
     ...
     */
    @discardableResult
    internal class func getConfigurationsByProjectId(projectId: String, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [ConfigurationModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func getConfigurationsByProjectIdWithRequestBuilder(projectId: String) -> RequestBuilder<[ConfigurationModel]> {
