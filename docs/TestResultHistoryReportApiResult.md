...
**testPlanGlobalId** | **Int64** | Global identifier of test plan related to the test result&#39;s test run | [optional] 
...
**links** | [LinkApiResult] | Test result links              If any test result related to the test run is linked with autotest, link will be equal to the links of last modified test result. Otherwise, the links equals to the links of first created test result in the test run. | [optional] 
...
**duration** | **Int64** | Duration of first created test result in the test run | [optional] 
...
**attachments** | [AttachmentApiResult] | Attachments related to the test result              If any test result related to the test run is linked with autotest, attachments will be equal to the attachments of last modified test result. Otherwise, the attachments equals to the attachments of first created test result in the test run. | [optional] 
...
**failureClassIds** | **[UUID]** | Unique identifier of failure classes related to the first test result in the test run | 
