//
// AutoTestProjectSettingsGetModel.swift
//
...
public struct AutoTestProjectSettingsGetModel: Codable, JSONEncodable, Hashable {
    ...
    public init(projectId: UUID, isFlakyAuto: Bool? = false, flakyStabilityPercentage: Int? = 100, flakyTestRunCount: Int? = 100, rerunEnabled: Bool, rerunAttemptsCount: Int) {
