...
public struct TestPlanPostModel: Codable, JSONEncodable, Hashable {
    ...
    public init(tags: [TagPostModel]? = nil, name: String, startDate: Date? = nil, endDate: Date? = nil, description: String? = nil, build: String? = nil, projectId: UUID, productName: String? = nil, hasAutomaticDurationTimer: Bool? = nil, attributes: [String: AnyCodable]) {
        self.tags = tags
        self.name = name
