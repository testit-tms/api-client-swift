...
internal class TestPointsAPI {
     ...
     */
    @discardableResult
    internal class func apiV2TestPointsIdTestRunsGet(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [TestRunModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2TestPointsIdTestRunsGetWithRequestBuilder(id: UUID) -> RequestBuilder<[TestRunModel]> {
     ...
     */
    @discardableResult
    internal class func apiV2TestPointsIdWorkItemGet(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: WorkItemModel?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2TestPointsIdWorkItemGetWithRequestBuilder(id: UUID) -> RequestBuilder<WorkItemModel> {
     ...
     */
    internal class func apiV2TestPointsSearchIdPostWithRequestBuilder(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, testPointFilterModel: TestPointFilterModel? = nil) -> RequestBuilder<[UUID]> {
     ...
     */
    @discardableResult
    internal class func apiV2TestPointsSearchPost(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, testPointFilterModel: TestPointFilterModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [TestPointShortGetModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2TestPointsSearchPostWithRequestBuilder(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, testPointFilterModel: TestPointFilterModel? = nil) -> RequestBuilder<[TestPointShortGetModel]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[TestPointShortGetModel]>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
