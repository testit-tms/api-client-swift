...
internal class CustomAttributeTemplatesAPI {
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesTemplatesIdCustomAttributesExcludePost(id: UUID, requestBody: Set<UUID>? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2CustomAttributesTemplatesIdCustomAttributesExcludePostWithRequestBuilder(id: UUID, requestBody: Set<UUID>? = nil) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesTemplatesIdCustomAttributesIncludePost(id: UUID, requestBody: Set<UUID>? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func apiV2CustomAttributesTemplatesIdCustomAttributesIncludePostWithRequestBuilder(id: UUID, requestBody: Set<UUID>? = nil) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesTemplatesIdDelete(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func apiV2CustomAttributesTemplatesIdDeleteWithRequestBuilder(id: UUID) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesTemplatesIdGet(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: CustomAttributeTemplateModel?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2CustomAttributesTemplatesIdGetWithRequestBuilder(id: UUID) -> RequestBuilder<CustomAttributeTemplateModel> {
        var localVariablePath = "/api/v2/customAttributes/templates/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<CustomAttributeTemplateModel>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesTemplatesNameGet(name: String, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: CustomAttributeTemplateModel?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<CustomAttributeTemplateModel> 
     */
    internal class func apiV2CustomAttributesTemplatesNameGetWithRequestBuilder(name: String) -> RequestBuilder<CustomAttributeTemplateModel> {
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesTemplatesPost(customAttributeTemplatePostModel: CustomAttributeTemplatePostModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: CustomAttributeTemplateModel?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<CustomAttributeTemplateModel> 
     */
    internal class func apiV2CustomAttributesTemplatesPostWithRequestBuilder(customAttributeTemplatePostModel: CustomAttributeTemplatePostModel? = nil) -> RequestBuilder<CustomAttributeTemplateModel> {
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesTemplatesPut(customAttributeTemplatePutModel: CustomAttributeTemplatePutModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func apiV2CustomAttributesTemplatesPutWithRequestBuilder(customAttributeTemplatePutModel: CustomAttributeTemplatePutModel? = nil) -> RequestBuilder<Void> {
        let localVariablePath = "/api/v2/customAttributes/templates"
        let localVariableURLString = ruTestitApiClientAPI.basePath + localVariablePath
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesTemplatesSearchPost(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, customAttributeTemplateSearchQueryModel: CustomAttributeTemplateSearchQueryModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [SearchCustomAttributeTemplateGetModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2CustomAttributesTemplatesSearchPostWithRequestBuilder(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, customAttributeTemplateSearchQueryModel: CustomAttributeTemplateSearchQueryModel? = nil) -> RequestBuilder<[SearchCustomAttributeTemplateGetModel]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[SearchCustomAttributeTemplateGetModel]>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
