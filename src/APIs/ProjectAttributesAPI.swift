...
internal class ProjectAttributesAPI {
     ...
     */
    @discardableResult
    internal class func createProjectsAttribute(projectId: String, customAttributePostModel: CustomAttributePostModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: CustomAttributeModel?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func createProjectsAttributeWithRequestBuilder(projectId: String, customAttributePostModel: CustomAttributePostModel? = nil) -> RequestBuilder<CustomAttributeModel> {
     ...
     */
    @discardableResult
    internal class func deleteProjectsAttribute(projectId: String, attributeId: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func deleteProjectsAttributeWithRequestBuilder(projectId: String, attributeId: UUID) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func getAttributeByProjectId(projectId: String, attributeId: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: CustomAttributeModel?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<CustomAttributeModel> 
     */
    internal class func getAttributeByProjectIdWithRequestBuilder(projectId: String, attributeId: UUID) -> RequestBuilder<CustomAttributeModel> {
        var localVariablePath = "/api/v2/projects/{projectId}/attributes/{attributeId}"
        let projectIdPreEscape = "\(APIHelper.mapValueToPathItem(projectId))"
        let projectIdPostEscape = projectIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{projectId}", with: projectIdPostEscape, options: .literal, range: nil)
     ...
     */
    @discardableResult
    internal class func getAttributesByProjectId(projectId: String, isDeleted: DeletionState? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [CustomAttributeModel]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<[CustomAttributeModel]> 
     */
    internal class func getAttributesByProjectIdWithRequestBuilder(projectId: String, isDeleted: DeletionState? = nil) -> RequestBuilder<[CustomAttributeModel]> {
        var localVariablePath = "/api/v2/projects/{projectId}/attributes"
        let projectIdPreEscape = "\(APIHelper.mapValueToPathItem(projectId))"
        let projectIdPostEscape = projectIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{projectId}", with: projectIdPostEscape, options: .literal, range: nil)
     ...
     */
    internal class func searchAttributesInProjectWithRequestBuilder(projectId: String, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, projectAttributesFilterModel: ProjectAttributesFilterModel? = nil) -> RequestBuilder<[CustomAttributeGetModel]> {
     ...
     */
    @discardableResult
    internal class func updateProjectsAttribute(projectId: String, customAttributePutModel: CustomAttributePutModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func updateProjectsAttributeWithRequestBuilder(projectId: String, customAttributePutModel: CustomAttributePutModel? = nil) -> RequestBuilder<Void> {
        var localVariablePath = "/api/v2/projects/{projectId}/attributes"
        let projectIdPreEscape = "\(APIHelper.mapValueToPathItem(projectId))"
        let projectIdPostEscape = projectIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{projectId}", with: projectIdPostEscape, options: .literal, range: nil)
