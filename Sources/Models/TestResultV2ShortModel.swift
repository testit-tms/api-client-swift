...
public struct TestResultV2ShortModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID, configurationId: UUID, workItemVersionId: UUID, autoTestId: UUID? = nil, message: String? = nil, traces: String? = nil, startedOn: Date? = nil, completedOn: Date? = nil, runByUserId: UUID? = nil, stoppedByUserId: UUID? = nil, testPointId: UUID? = nil, testPoint: TestPointShortModel? = nil, testRunId: UUID, outcome: String, comment: String? = nil, links: [LinkModel]? = nil, attachments: [AttachmentModel]? = nil, parameters: [String: String]? = nil, properties: [String: String]? = nil) {
        self.id = id
