...
internal class ProjectAttributeTemplatesAPI {
    ...
    internal class func apiV2ProjectsProjectIdAttributesTemplatesSearchPostWithRequestBuilder(projectId: String, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, projectCustomAttributesTemplatesFilterModel: ProjectCustomAttributesTemplatesFilterModel? = nil) -> RequestBuilder<[ProjectCustomAttributeTemplateGetModel]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[ProjectCustomAttributeTemplateGetModel]>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdAttributesTemplatesTemplateIdDelete(projectId: String, templateId: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2ProjectsProjectIdAttributesTemplatesTemplateIdDeleteWithRequestBuilder(projectId: String, templateId: UUID) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdAttributesTemplatesTemplateIdPost(projectId: String, templateId: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func apiV2ProjectsProjectIdAttributesTemplatesTemplateIdPostWithRequestBuilder(projectId: String, templateId: UUID) -> RequestBuilder<Void> {
        var localVariablePath = "/api/v2/projects/{projectId}/attributes/templates/{templateId}"
        let projectIdPreEscape = "\(APIHelper.mapValueToPathItem(projectId))"
        let projectIdPostEscape = projectIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{projectId}", with: projectIdPostEscape, options: .literal, range: nil)
