//
// TestSuiteWorkItemsSearchModel.swift
//
...
internal struct TestSuiteWorkItemsSearchModel: Codable, JSONEncodable, Hashable {
    ...
    internal var types: Set<WorkItemEntityTypes>?
    ...
    internal var duration: Int32RangeSelectorModel?
    /** Specifies a work item median duration range to search for */
    internal var medianDuration: Int64RangeSelectorModel?
