//
// TestPlanWithAnalyticModel.swift
//
...
internal struct TestPlanWithAnalyticModel: Codable, JSONEncodable, Hashable {
    ...
    internal var analytic: TestPointAnalyticResult
