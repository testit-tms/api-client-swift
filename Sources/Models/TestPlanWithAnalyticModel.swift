...
public struct TestPlanWithAnalyticModel: Codable, JSONEncodable, Hashable {
    ...
    public var analytic: TestPointAnalyticResult
...
extension TestPlanWithAnalyticModel: Identifiable {}
