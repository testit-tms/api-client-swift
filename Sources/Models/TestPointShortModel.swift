...
public struct TestPointShortModel: Codable, JSONEncodable, Hashable {
    ...
    public init(testSuiteId: UUID, id: UUID, testerId: UUID? = nil, workItemId: UUID? = nil, configurationId: UUID? = nil, status: String? = nil, lastTestResultId: UUID? = nil, iterationId: UUID, workItemMedianDuration: Int64? = nil) {
