...
internal struct ValidationProblemDetails: Codable, JSONEncodable, Hashable {
    ...
    internal init(errors: [String: [String]], type: String? = nil, title: String? = nil, status: Int? = nil, detail: String? = nil, instance: String? = nil) {
        self.errors = errors
        self.type = type
        self.title = title
        self.status = status
