...
public struct AttachmentPutModelAutoTestStepResultsModel: Codable, JSONEncodable, Hashable {
    ...
    public init(title: String? = nil, description: String? = nil, info: String? = nil, startedOn: Date? = nil, completedOn: Date? = nil, duration: Int64? = nil, outcome: AvailableTestResultOutcome? = nil, stepResults: [AttachmentPutModelAutoTestStepResultsModel]? = nil, attachments: [AttachmentPutModel]? = nil, parameters: [String: String]? = nil) {
        self.title = title
