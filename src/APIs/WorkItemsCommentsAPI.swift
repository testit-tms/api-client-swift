...
internal class WorkItemsCommentsAPI {
     ...
     */
    @discardableResult
    internal class func apiV2WorkItemsCommentsCommentIdDelete(commentId: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2WorkItemsCommentsCommentIdDeleteWithRequestBuilder(commentId: UUID) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2WorkItemsCommentsPost(workItemCommentPostModel: WorkItemCommentPostModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: WorkItemCommentModel?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2WorkItemsCommentsPostWithRequestBuilder(workItemCommentPostModel: WorkItemCommentPostModel? = nil) -> RequestBuilder<WorkItemCommentModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<WorkItemCommentModel>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    internal class func apiV2WorkItemsCommentsPut(workItemCommentPutModel: WorkItemCommentPutModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func apiV2WorkItemsCommentsPutWithRequestBuilder(workItemCommentPutModel: WorkItemCommentPutModel? = nil) -> RequestBuilder<Void> {
        let localVariablePath = "/api/v2/workItems/comments"
        let localVariableURLString = ruTestitApiClientAPI.basePath + localVariablePath
     ...
     */
    @discardableResult
    internal class func apiV2WorkItemsIdCommentsGet(id: String, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [WorkItemCommentModel]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<[WorkItemCommentModel]> 
     */
    internal class func apiV2WorkItemsIdCommentsGetWithRequestBuilder(id: String) -> RequestBuilder<[WorkItemCommentModel]> {
