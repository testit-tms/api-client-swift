...
public struct SearchWebhooksQueryModel: Codable, JSONEncodable, Hashable {
    ...
    public var eventTypes: Set<WebHookEventTypeModel>?
    /** Specifies a webhook methods to search for */
    public var methods: Set<RequestTypeModel>?
    ...
    public init(name: String? = nil, eventTypes: Set<WebHookEventTypeModel>? = nil, methods: Set<RequestTypeModel>? = nil, projectIds: Set<UUID>? = nil, isEnabled: Bool? = nil) {
        self.name = name
