...
internal class ProjectImportAPI {
    ...
    @discardableResult
    internal class func backgroundImportToExistingProject(projectId: String, file: URL? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: UUID?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    internal class func backgroundImportToExistingProjectWithRequestBuilder(projectId: String, file: URL? = nil) -> RequestBuilder<UUID> {
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    internal class func backgroundImportZipToExistingProject(projectId: String, file: URL? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: UUID?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    internal class func backgroundImportZipToExistingProjectWithRequestBuilder(projectId: String, file: URL? = nil) -> RequestBuilder<UUID> {
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    internal class func importToExistingProject(projectId: String, includeAttachments: Bool? = nil, file: URL? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    internal class func importToExistingProjectWithRequestBuilder(projectId: String, includeAttachments: Bool? = nil, file: URL? = nil) -> RequestBuilder<Void> {
