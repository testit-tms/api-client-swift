...
```swift
    open class func apiV2TestPointsIdTestRunsGet(id: UUID, completion: @escaping (_ data: [TestRunModel]?, _ error: Error?) -> Void)
```
...
```swift
    open class func apiV2TestPointsSearchIdPost(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, testPointFilterModel: TestPointFilterModel? = nil, completion: @escaping (_ data: [UUID]?, _ error: Error?) -> Void)
```
...
```swift
    open class func apiV2TestPointsSearchPost(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, testPointFilterModel: TestPointFilterModel? = nil, completion: @escaping (_ data: [TestPointShortGetModel]?, _ error: Error?) -> Void)
```
