...
```swift
    open class func apiV2TestStatusesSearchPost(searchTestStatusesApiModel: SearchTestStatusesApiModel? = nil, completion: @escaping (_ data: TestStatusApiResultIReply?, _ error: Error?) -> Void)
```
