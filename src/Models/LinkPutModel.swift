...
internal struct LinkPutModel: Codable, JSONEncodable, Hashable {
    ...
    internal init(id: UUID? = nil, title: String? = nil, url: String, description: String? = nil, type: LinkType? = nil, hasInfo: Bool) {
        self.id = id
        self.title = title
        self.url = url
