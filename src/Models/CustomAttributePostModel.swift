...
internal struct CustomAttributePostModel: Codable, JSONEncodable, Hashable {
    ...
    internal init(options: [CustomAttributeOptionPostModel]? = nil, type: CustomAttributeTypesEnum, name: String, isEnabled: Bool, isRequired: Bool, isGlobal: Bool) {
