...
internal class ProjectWorkItemsAPI {
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdWorkItemsSearchGroupedPost(projectId: String, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, workItemGroupGetModel: WorkItemGroupGetModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [WorkItemGroupModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2ProjectsProjectIdWorkItemsSearchGroupedPostWithRequestBuilder(projectId: String, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, workItemGroupGetModel: WorkItemGroupGetModel? = nil) -> RequestBuilder<[WorkItemGroupModel]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[WorkItemGroupModel]>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdWorkItemsSearchIdPost(projectId: String, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, workItemSelectModel: WorkItemSelectModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [UUID]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2ProjectsProjectIdWorkItemsSearchIdPostWithRequestBuilder(projectId: String, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, workItemSelectModel: WorkItemSelectModel? = nil) -> RequestBuilder<[UUID]> {
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdWorkItemsSearchPost(projectId: String, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, workItemSelectModel: WorkItemSelectModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [WorkItemShortModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2ProjectsProjectIdWorkItemsSearchPostWithRequestBuilder(projectId: String, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, workItemSelectModel: WorkItemSelectModel? = nil) -> RequestBuilder<[WorkItemShortModel]> {
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdWorkItemsTagsGet(projectId: UUID, isDeleted: Bool? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [TagShortModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2ProjectsProjectIdWorkItemsTagsGetWithRequestBuilder(projectId: UUID, isDeleted: Bool? = nil) -> RequestBuilder<[TagShortModel]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[TagShortModel]>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
    ...
    @discardableResult
    internal class func getWorkItemsByProjectId(projectId: String, isDeleted: Bool? = nil, tagNames: [String]? = nil, includeIterations: Bool? = nil, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [WorkItemShortModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    internal class func getWorkItemsByProjectIdWithRequestBuilder(projectId: String, isDeleted: Bool? = nil, tagNames: [String]? = nil, includeIterations: Bool? = nil, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil) -> RequestBuilder<[WorkItemShortModel]> {
