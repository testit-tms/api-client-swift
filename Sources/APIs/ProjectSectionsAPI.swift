...
open class ProjectSectionsAPI {
     ...
     */
    @discardableResult
    open class func getSectionsByProjectId(projectId: String, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, apiResponseQueue: DispatchQueue = TestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [SectionModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    open class func getSectionsByProjectIdWithRequestBuilder(projectId: String, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil) -> RequestBuilder<[SectionModel]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[SectionModel]>.Type = TestitApiClientAPI.requestBuilderFactory.getBuilder()
