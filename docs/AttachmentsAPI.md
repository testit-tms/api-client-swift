...
```swift
    internal class func apiV2AttachmentsIdDelete(id: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2AttachmentsIdGet(id: UUID, width: Int? = nil, height: Int? = nil, resizeType: ImageResizeType? = nil, backgroundColor: String? = nil, preview: Bool? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2AttachmentsOccupiedFileStorageSizeGet(completion: @escaping (_ data: Int64?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2AttachmentsPost(file: URL? = nil, completion: @escaping (_ data: AttachmentModel?, _ error: Error?) -> Void)
```
