...
public struct ProjectApiResult: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID, description: String? = nil, name: String, isFavorite: Bool, attributesScheme: [CustomAttributeApiResult]? = nil, testPlansAttributesScheme: [CustomAttributeApiResult]? = nil, testCasesCount: Int? = nil, sharedStepsCount: Int? = nil, checkListsCount: Int? = nil, autoTestsCount: Int? = nil, isDeleted: Bool, createdDate: Date, modifiedDate: Date? = nil, createdById: UUID, modifiedById: UUID? = nil, globalId: Int64, type: ProjectType, isFlakyAuto: Bool, workflowId: UUID) {
        self.id = id
