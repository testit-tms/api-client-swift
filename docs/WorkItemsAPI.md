...
```swift
    internal class func apiV2WorkItemsIdAttachmentsPost(id: UUID, file: URL? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsIdCheckListTransformToTestCasePost(id: UUID, completion: @escaping (_ data: WorkItemModel?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsIdHistoryGet(id: UUID, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, completion: @escaping (_ data: [WorkItemChangeModel]?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsIdLikeDelete(id: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsIdLikePost(id: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsIdLikesCountGet(id: UUID, completion: @escaping (_ data: Int?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsIdLikesGet(id: UUID, completion: @escaping (_ data: [WorkItemLikeModel]?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsIdTestResultsHistoryGet(id: UUID, from: Date? = nil, to: Date? = nil, configurationIds: [UUID]? = nil, testPlanIds: [UUID]? = nil, userIds: [UUID]? = nil, outcomes: [String]? = nil, isAutomated: Bool? = nil, automated: Bool? = nil, testRunIds: [UUID]? = nil, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, completion: @escaping (_ data: [TestResultHistoryReportModel]?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsIdVersionVersionIdActualPost(id: UUID, versionId: UUID, completion: @escaping (_ data: WorkItemModel?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsMovePost(workItemMovePostModel: WorkItemMovePostModel? = nil, completion: @escaping (_ data: WorkItemShortModel?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsSearchPost(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, workItemSelectModel: WorkItemSelectModel? = nil, completion: @escaping (_ data: [WorkItemShortModel]?, _ error: Error?) -> Void)
```
...
```swift
    internal class func apiV2WorkItemsSharedStepsSharedStepIdReferencesGet(sharedStepId: UUID, completion: @escaping (_ data: [SharedStepReferenceModel]?, _ error: Error?) -> Void)
```
...
# **createWorkItem**
```swift
    internal class func createWorkItem(workItemPostModel: WorkItemPostModel? = nil, completion: @escaping (_ data: WorkItemModel?, _ error: Error?) -> Void)
```
...
```swift
    internal class func deleteAllWorkItemsFromAutoTest(id: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **deleteWorkItem**
```swift
    internal class func deleteWorkItem(id: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal class func getAutoTestsForWorkItem(id: String, completion: @escaping (_ data: [AutoTestModel]?, _ error: Error?) -> Void)
```
...
# **getIterations**
```swift
    internal class func getIterations(id: String, versionId: UUID? = nil, versionNumber: Int? = nil, completion: @escaping (_ data: [IterationModel]?, _ error: Error?) -> Void)
```
...
# **getWorkItemById**
```swift
    internal class func getWorkItemById(id: String, versionId: UUID? = nil, versionNumber: Int? = nil, completion: @escaping (_ data: WorkItemModel?, _ error: Error?) -> Void)
```
...
```swift
    internal class func getWorkItemChronology(id: String, completion: @escaping (_ data: [TestResultChronologyModel]?, _ error: Error?) -> Void)
```
...
# **getWorkItemVersions**
```swift
    internal class func getWorkItemVersions(id: String, workItemVersionId: UUID? = nil, versionNumber: Int? = nil, completion: @escaping (_ data: [WorkItemVersionModel]?, _ error: Error?) -> Void)
```
...
# **purgeWorkItem**
```swift
    internal class func purgeWorkItem(id: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **restoreWorkItem**
```swift
    internal class func restoreWorkItem(id: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **updateWorkItem**
```swift
    internal class func updateWorkItem(workItemPutModel: WorkItemPutModel? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
