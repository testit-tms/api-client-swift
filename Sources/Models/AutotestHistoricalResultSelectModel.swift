...
public struct AutotestHistoricalResultSelectModel: Codable, JSONEncodable, Hashable {
    ...
    public init(outcomes: Set<AutotestResultOutcome>? = nil, testPlanIds: Set<UUID>? = nil, testRunIds: Set<UUID>? = nil, configurationIds: Set<UUID>? = nil, launchSource: String? = nil, userIds: Set<UUID>? = nil, duration: Int64RangeSelectorModel? = nil) {
