...
internal class ProjectTestPlansAPI {
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdTestPlansAnalyticsGet(projectId: UUID, isDeleted: Bool? = nil, mustUpdateCache: Bool? = nil, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [TestPlanWithAnalyticModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2ProjectsProjectIdTestPlansAnalyticsGetWithRequestBuilder(projectId: UUID, isDeleted: Bool? = nil, mustUpdateCache: Bool? = nil, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil) -> RequestBuilder<[TestPlanWithAnalyticModel]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[TestPlanWithAnalyticModel]>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdTestPlansDeleteBulkPost(projectId: String, testPlanSelectModel: TestPlanSelectModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [UUID]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2ProjectsProjectIdTestPlansDeleteBulkPostWithRequestBuilder(projectId: String, testPlanSelectModel: TestPlanSelectModel? = nil) -> RequestBuilder<[UUID]> {
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdTestPlansNameExistsGet(projectId: UUID, name: String, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Bool?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2ProjectsProjectIdTestPlansNameExistsGetWithRequestBuilder(projectId: UUID, name: String) -> RequestBuilder<Bool> {
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdTestPlansPurgeBulkPost(projectId: String, testPlanSelectModel: TestPlanSelectModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2ProjectsProjectIdTestPlansPurgeBulkPostWithRequestBuilder(projectId: String, testPlanSelectModel: TestPlanSelectModel? = nil) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdTestPlansRestoreBulkPost(projectId: String, testPlanSelectModel: TestPlanSelectModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [UUID]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<[UUID]> 
     */
    internal class func apiV2ProjectsProjectIdTestPlansRestoreBulkPostWithRequestBuilder(projectId: String, testPlanSelectModel: TestPlanSelectModel? = nil) -> RequestBuilder<[UUID]> {
     ...
     */
    @discardableResult
    internal class func apiV2ProjectsProjectIdTestPlansSearchPost(projectId: String, mustUpdateCache: Bool? = nil, skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, projectTestPlansFilterModel: ProjectTestPlansFilterModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [TestPlanWithAnalyticModel]?, _ error: Error?) -> Void)) -> RequestTask {
