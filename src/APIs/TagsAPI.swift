...
internal class TagsAPI {
     ...
     */
    @discardableResult
    internal class func apiV2TagsDelete(tagSelectModel: TagSelectModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2TagsDeleteWithRequestBuilder(tagSelectModel: TagSelectModel? = nil) -> RequestBuilder<Void> {
    ...
    @discardableResult
    internal class func apiV2TagsGet(apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [TagModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    internal class func apiV2TagsGetWithRequestBuilder() -> RequestBuilder<[TagModel]> {
        let localVariablePath = "/api/v2/tags"
        let localVariableURLString = ruTestitApiClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<[TagModel]>.Type = ruTestitApiClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    internal class func apiV2TagsIdDelete(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    internal class func apiV2TagsIdDeleteWithRequestBuilder(id: UUID) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2TagsPost(tagPostModel: TagPostModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: TagModel?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<TagModel> 
     */
    internal class func apiV2TagsPostWithRequestBuilder(tagPostModel: TagPostModel? = nil) -> RequestBuilder<TagModel> {
        let localVariablePath = "/api/v2/tags"
        let localVariableURLString = ruTestitApiClientAPI.basePath + localVariablePath
     ...
     */
    @discardableResult
    internal class func apiV2TagsPut(id: UUID? = nil, tagPutModel: TagPutModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: TagModel?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<TagModel> 
     */
    internal class func apiV2TagsPutWithRequestBuilder(id: UUID? = nil, tagPutModel: TagPutModel? = nil) -> RequestBuilder<TagModel> {
        let localVariablePath = "/api/v2/tags"
        let localVariableURLString = ruTestitApiClientAPI.basePath + localVariablePath
     ...
     */
    @discardableResult
    internal class func apiV2TagsSearchGet(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [TagModel]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<[TagModel]> 
     */
    internal class func apiV2TagsSearchGetWithRequestBuilder(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil) -> RequestBuilder<[TagModel]> {
     ...
     */
    @discardableResult
    internal class func apiV2TagsTestPlansTagsGet(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [TagModel]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<[TagModel]> 
     */
    internal class func apiV2TagsTestPlansTagsGetWithRequestBuilder(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil) -> RequestBuilder<[TagModel]> {
