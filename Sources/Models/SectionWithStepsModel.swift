...
public struct SectionWithStepsModel: Codable, JSONEncodable, Hashable {
    ...
    public init(attachments: [AttachmentModel]? = nil, preconditionSteps: [StepModel]? = nil, postconditionSteps: [StepModel]? = nil, projectId: UUID? = nil, parentId: UUID? = nil, isDeleted: Bool, id: UUID, createdDate: Date, modifiedDate: Date? = nil, createdById: UUID, modifiedById: UUID? = nil, name: String) {
