...
open class ProjectTestPlanAttributesAPI {
     ...
     */
    @discardableResult
    open class func createCustomAttributeTestPlanProjectRelations(projectId: String, requestBody: Set<UUID>? = nil, apiResponseQueue: DispatchQueue = TestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    open class func createCustomAttributeTestPlanProjectRelationsWithRequestBuilder(projectId: String, requestBody: Set<UUID>? = nil) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    open class func deleteCustomAttributeTestPlanProjectRelations(projectId: String, attributeId: UUID, apiResponseQueue: DispatchQueue = TestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func deleteCustomAttributeTestPlanProjectRelationsWithRequestBuilder(projectId: String, attributeId: UUID) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    open class func getCustomAttributeTestPlanProjectRelations(projectId: String, apiResponseQueue: DispatchQueue = TestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [CustomAttributeModel]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    open class func getCustomAttributeTestPlanProjectRelationsWithRequestBuilder(projectId: String) -> RequestBuilder<[CustomAttributeModel]> {
        var localVariablePath = "/api/v2/projects/{projectId}/testPlans/attributes"
        let projectIdPreEscape = "\(APIHelper.mapValueToPathItem(projectId))"
        let projectIdPostEscape = projectIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{projectId}", with: projectIdPostEscape, options: .literal, range: nil)
     ...
     */
    @discardableResult
    open class func updateCustomAttributeTestPlanProjectRelations(projectId: String, customAttributeTestPlanProjectRelationPutModel: CustomAttributeTestPlanProjectRelationPutModel? = nil, apiResponseQueue: DispatchQueue = TestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateCustomAttributeTestPlanProjectRelationsWithRequestBuilder(projectId: String, customAttributeTestPlanProjectRelationPutModel: CustomAttributeTestPlanProjectRelationPutModel? = nil) -> RequestBuilder<Void> {
        var localVariablePath = "/api/v2/projects/{projectId}/testPlans/attributes"
        let projectIdPreEscape = "\(APIHelper.mapValueToPathItem(projectId))"
        let projectIdPostEscape = projectIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{projectId}", with: projectIdPostEscape, options: .literal, range: nil)
