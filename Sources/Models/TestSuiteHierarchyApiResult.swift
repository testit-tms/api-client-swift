//
// TestSuiteHierarchyApiResult.swift
//
...
public struct TestSuiteHierarchyApiResult: Codable, JSONEncodable, Hashable {
    ...
    public var children: [TestSuiteHierarchyApiResult]?

    public init(id: UUID, name: String, type: TestSuiteTypeApiResult, saveStructure: Bool?, autoRefresh: Bool?, refreshDate: Date?, parentId: UUID?, testPlanId: UUID?, children: [TestSuiteHierarchyApiResult]? = nil) {
        self.id = id
        self.name = name
        self.type = type
...
extension TestSuiteHierarchyApiResult: Identifiable {}
