# Swift5 API client for ruTestitApiClient
...
## Documentation For Models
 ...
 - [ApiV2AttachmentsPostRequest](docs/ApiV2AttachmentsPostRequest.md)
 ...
 - [AttachmentModelAutoTestStepResultsModel](docs/AttachmentModelAutoTestStepResultsModel.md)
 ...
 - [AutoTestShortModel](docs/AutoTestShortModel.md)
 - [AutoTestStepModel](docs/AutoTestStepModel.md)
 - [AutotestFilterModel](docs/AutotestFilterModel.md)
 - [AutotestHistoricalResultSelectModel](docs/AutotestHistoricalResultSelectModel.md)
 - [AutotestResultHistoricalGetModel](docs/AutotestResultHistoricalGetModel.md)
 - [AutotestResultOutcome](docs/AutotestResultOutcome.md)
 - [AutotestResultReasonSubGetModel](docs/AutotestResultReasonSubGetModel.md)
 - [AutotestSelectModel](docs/AutotestSelectModel.md)
 - [AutotestsExtractionModel](docs/AutotestsExtractionModel.md)
 - [AutotestsSelectModel](docs/AutotestsSelectModel.md)
 ...
 - [FailureClassModel](docs/FailureClassModel.md)
 - [FailureClassRegexModel](docs/FailureClassRegexModel.md)
 - [FilterModel](docs/FilterModel.md)
 - [FlakyBulkModel](docs/FlakyBulkModel.md)
 ...
 - [LinkSubGetModel](docs/LinkSubGetModel.md)
 - [LinkType](docs/LinkType.md)
 - [NamedEntityModel](docs/NamedEntityModel.md)
 ...
 - [ParameterFilterModel](docs/ParameterFilterModel.md)
 - [ParameterGroupModel](docs/ParameterGroupModel.md)
 ...
 - [PublicTestPointModel](docs/PublicTestPointModel.md)
 - [PublicTestRunModel](docs/PublicTestRunModel.md)
 - [RequestTypeModel](docs/RequestTypeModel.md)
 - [SearchAutoTestsQueryIncludesModel](docs/SearchAutoTestsQueryIncludesModel.md)
 ...
 - [TagExtractionModel](docs/TagExtractionModel.md)
 - [TagModel](docs/TagModel.md)
 - [TagPostModel](docs/TagPostModel.md)
 - [TagPutModel](docs/TagPutModel.md)
 - [TagSelectModel](docs/TagSelectModel.md)
 - [TagShortModel](docs/TagShortModel.md)
 - [TagsFilterModel](docs/TagsFilterModel.md)
 ...
 - [TestPointPutModel](docs/TestPointPutModel.md)
 - [TestPointResultModel](docs/TestPointResultModel.md)
 - [TestPointSelectModel](docs/TestPointSelectModel.md)
 - [TestPointSelector](docs/TestPointSelector.md)
 - [TestPointShortGetModel](docs/TestPointShortGetModel.md)
 - [TestPointShortModel](docs/TestPointShortModel.md)
 - [TestPointStatus](docs/TestPointStatus.md)
 - [TestPointWithLastResultModel](docs/TestPointWithLastResultModel.md)
 ...
 - [TestResultModel](docs/TestResultModel.md)
 - [TestResultOutcome](docs/TestResultOutcome.md)
 - [TestResultShortGetModel](docs/TestResultShortGetModel.md)
 - [TestResultShortModel](docs/TestResultShortModel.md)
 - [TestResultStepCommentPutModel](docs/TestResultStepCommentPutModel.md)
 - [TestResultUpdateModel](docs/TestResultUpdateModel.md)
 - [TestResultV2GetModel](docs/TestResultV2GetModel.md)
 - [TestResultV2ShortModel](docs/TestResultV2ShortModel.md)
 - [TestResultsFilterModel](docs/TestResultsFilterModel.md)
 - [TestResultsLocalFilterModel](docs/TestResultsLocalFilterModel.md)
 - [TestResultsStatisticsGetModel](docs/TestResultsStatisticsGetModel.md)
 - [TestRunAnalyticResultModel](docs/TestRunAnalyticResultModel.md)
 - [TestRunExtractionModel](docs/TestRunExtractionModel.md)
 ...
 - [TestRunFilterModel](docs/TestRunFilterModel.md)
 - [TestRunGroupByFailureClassModel](docs/TestRunGroupByFailureClassModel.md)
 - [TestRunGroupByStatusModel](docs/TestRunGroupByStatusModel.md)
 - [TestRunModel](docs/TestRunModel.md)
 - [TestRunSearchQueryModel](docs/TestRunSearchQueryModel.md)
 - [TestRunSelectModel](docs/TestRunSelectModel.md)
 - [TestRunShortGetModel](docs/TestRunShortGetModel.md)
 - [TestRunShortModel](docs/TestRunShortModel.md)
 - [TestRunState](docs/TestRunState.md)
 - [TestRunStatisticsErrorCategoriesGetModel](docs/TestRunStatisticsErrorCategoriesGetModel.md)
 - [TestRunStatisticsStatusesGetModel](docs/TestRunStatisticsStatusesGetModel.md)
 ...
 - [TestRunUpdateMultipleModel](docs/TestRunUpdateMultipleModel.md)
 ...
 - [UpdateAttachmentShortModel](docs/UpdateAttachmentShortModel.md)
 - [UpdateLinkShortModel](docs/UpdateLinkShortModel.md)
 ...
 - [WebHookLogModel](docs/WebHookLogModel.md)
 ...
 - [WorkItemIdentifierModel](docs/WorkItemIdentifierModel.md)
