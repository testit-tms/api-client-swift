...
public struct DetailedProjectApiResult: Codable, JSONEncodable, Hashable {
    ...
    public init(attributesScheme: [CustomAttributeApiResult]? = nil, testPlansAttributesScheme: [CustomAttributeApiResult]? = nil, id: UUID, description: String? = nil, name: String, isFavorite: Bool, workItemsCount: Int64, testCasesCount: Int64? = nil, sharedStepsCount: Int64? = nil, checkListsCount: Int64? = nil, autoTestsCount: Int64? = nil, isDeleted: Bool, createdDate: Date, modifiedDate: Date? = nil, createdById: UUID, modifiedById: UUID? = nil, globalId: Int64, type: ProjectType, workflowId: UUID) {
