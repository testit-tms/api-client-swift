...
public struct TestRunFillByAutoTestsPostModel: Codable, JSONEncodable, Hashable {
    ...
    public init(projectId: UUID, name: String? = nil, configurationIds: [UUID], autoTestExternalIds: [String], description: String? = nil, launchSource: String? = nil, attachments: [AttachmentPutModel]? = nil, links: [LinkPostModel]? = nil) {
