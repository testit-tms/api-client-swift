...
internal class CustomAttributesAPI {
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesGlobalIdDelete(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2CustomAttributesGlobalIdDeleteWithRequestBuilder(id: UUID) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesGlobalIdPut(id: UUID, globalCustomAttributeUpdateModel: GlobalCustomAttributeUpdateModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: CustomAttributeModel?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    internal class func apiV2CustomAttributesGlobalIdPutWithRequestBuilder(id: UUID, globalCustomAttributeUpdateModel: GlobalCustomAttributeUpdateModel? = nil) -> RequestBuilder<CustomAttributeModel> {
        var localVariablePath = "/api/v2/customAttributes/global/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesGlobalPost(globalCustomAttributePostModel: GlobalCustomAttributePostModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: CustomAttributeModel?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<CustomAttributeModel> 
     */
    internal class func apiV2CustomAttributesGlobalPostWithRequestBuilder(globalCustomAttributePostModel: GlobalCustomAttributePostModel? = nil) -> RequestBuilder<CustomAttributeModel> {
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesIdGet(id: UUID, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: CustomAttributeModel?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<CustomAttributeModel> 
     */
    internal class func apiV2CustomAttributesIdGetWithRequestBuilder(id: UUID) -> RequestBuilder<CustomAttributeModel> {
     ...
     */
    @discardableResult
    internal class func apiV2CustomAttributesSearchPost(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, customAttributeSearchQueryModel: CustomAttributeSearchQueryModel? = nil, apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [CustomAttributeModel]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - returns: RequestBuilder<[CustomAttributeModel]> 
     */
    internal class func apiV2CustomAttributesSearchPostWithRequestBuilder(skip: Int? = nil, take: Int? = nil, orderBy: String? = nil, searchField: String? = nil, searchValue: String? = nil, customAttributeSearchQueryModel: CustomAttributeSearchQueryModel? = nil) -> RequestBuilder<[CustomAttributeModel]> {
