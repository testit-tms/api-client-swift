...
internal struct TestPointByTestSuiteModel: Codable, JSONEncodable, Hashable {
    ...
    internal init(id: UUID, testerId: UUID? = nil, workItemId: UUID? = nil, configurationId: UUID? = nil, status: String? = nil, lastTestResultId: UUID? = nil, iterationId: UUID, workItemMedianDuration: Int64? = nil) {
        self.id = id
