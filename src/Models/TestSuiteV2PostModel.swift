...
internal struct TestSuiteV2PostModel: Codable, JSONEncodable, Hashable {
    ...
    internal init(parentId: UUID? = nil, testPlanId: UUID, name: String, type: TestSuiteType? = nil, saveStructure: Bool? = nil, autoRefresh: Bool? = nil) {
