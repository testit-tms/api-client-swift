...
#endif
internal class ruTestitApiClientAPI {
...
internal class RequestBuilder<T> {
    ...
    required internal init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:], requiresAuthentication: Bool) {
        ...
        addHeaders(ruTestitApiClientAPI.customHeaders)
    }
    ...
    @discardableResult
    internal func execute(_ apiResponseQueue: DispatchQueue = ruTestitApiClientAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
        return requestTask
    }
    ...
    internal func addCredential() -> Self {
        credential = ruTestitApiClientAPI.credential
        return self
    }
}
